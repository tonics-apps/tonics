...
if (document.querySelector('.audio-player')){
    ...
    new myModule.MenuToggle('.audio-player', new myModule.Query())
    ...
    new myModule.MenuToggle('.audio-player-queue', new myModule.Query())
