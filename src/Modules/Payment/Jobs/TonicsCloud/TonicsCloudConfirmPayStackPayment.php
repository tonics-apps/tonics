...
class TonicsCloudConfirmPayStackPayment extends AbstractJobInterface implements JobHandlerInterface
{

    public function __construct()
    {
        $this->setJobName('Core_TonicsCloudConfirmPayStackPayment');
    ...
    public function handle(): void
    {
        ...
        $response = Helper::PayStackOrderDetails(Helper::PayStackSecretKey(), $invoiceID);
