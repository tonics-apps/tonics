...
use App\Modules\Field\RequestInterceptor\FieldRenderAccess;
        ...
        $route->group('/admin/tools', function (Route $route) {
            ...
            $route->group('/field', function (Route $route) {
                ...
                $route->group('', function (Route $route) {
                    ...
                    # FOR LOADING FIELDS
                    # --------------
                    $route->get('/get-field-items', [FieldController::class, 'getFieldItemsAPI'], [FieldRenderAccess::class], alias: 'getFieldItemsAPI');
