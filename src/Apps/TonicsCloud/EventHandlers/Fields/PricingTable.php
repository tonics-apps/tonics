...
FRAG;
        ...
        db( onGetDB: function (TonicsQuery $db) use ($providerName, &$services){
            ...
            $services = $db->Select('tcs.service_id, tcs.service_name, tcs.service_description, tcs.monthly_cap, tcs.hourly_rate')
                ->From("$tcs tcs")
        ...
        <tr class="disable-select">
            ...
            <td tabindex="-1" style="opacity: 50%;">$$service->monthly_cap</td>
            <td tabindex="-1" style="opacity: 50%;">$$service->hourly_rate</td>  
        </tr>
Frag;
                    continue;
                }
        ...
        <tr class="">
            ...
            <td tabindex="-1">$$service->monthly_cap</td>
            <td tabindex="-1">$$service->hourly_rate</td>  
        </tr>
Frag;
            }
        }
