...
class CloudJobQueueUpdateInstanceStatus extends AbstractJobInterface implements JobHandlerInterface
{
    ...
    {
        $this->getHandler()->changeInstanceStatus($this->getDataAsArray());
    }
}