...
class TonicsCloudActivator implements ExtensionConfig, FieldItemsExtensionConfig
{
    ...
    static array $TABLES = [
        ...
        self::TONICS_CLOUD_DNS => ['dns_record_id', 'slug_id', 'dns_domain', 'dns_status_msg', 'fk_customer_id', 'fk_provider_id', 'others', 'created_at', 'updated_at'],
    ];
...
[
	...
	{
		"fk_field_id": "App TonicsCloud [Instance Page]",
		"field_name": "modular_rowcolumn",
		"field_id": 1,
		"field_parent_id": null,
	...
	{
		"fk_field_id": "App TonicsCloud [Image Page]",
		"field_name": "modular_rowcolumn",
		"field_id": 1,
		"field_parent_id": null,
	...
	},
	{
		...
		"field_id": 3,
		"field_parent_id": 1,
		"field_options": "{\"field_validations\":[],\"field_sanitization\":[],\"field_slug\":\"input_select\",\"input_select_cell\":\"1\",\"field_slug_unique_hash\":\"2v741lsnhuo0000000000\",\"field_input_name\":\"acme_mode\",\"fieldName\":\"Modes\",\"inputName\":\"acme_mode\",\"selectData\":\"nginx:Nginx,apache2:Apache2,standalone:Standalone\",\"defaultValue\":\"Nginx\"}"
	},
	{
		"fk_field_id": "App TonicsCloud  [App Config] [ACME]",
		"field_name": "input_select",
		"field_id": 4,
		"field_parent_id": 1,
		"field_options": "{\"field_validations\":[],\"field_sanitization\":[],\"field_slug\":\"input_select\",\"input_select_cell\":\"1\",\"field_slug_unique_hash\":\"3heecqdehdk0000000000\",\"field_input_name\":\"acme_issuer\",\"fieldName\":\"Issuer\",\"inputName\":\"acme_issuer\",\"selectData\":\"Letsencrypt,ZeroSSL\",\"defaultValue\":\"Letsencrypt\"}"
	},
	{
		"fk_field_id": "App TonicsCloud  [App Config] [ACME]",
		"field_name": "modular_rowcolumnrepeater",
	...
	{
		"fk_field_id": "App TonicsCloud  [App Config] [Default]",
		"field_name": "input_text",
		"field_id": 1,
		"field_parent_id": null,
	...
	{
		"fk_field_id": "App TonicsCloud [Billing Page]",
	...
	{
		"fk_field_id": "App TonicsCloud [App Config] [Upload Unzip]",
		"field_name": "modular_rowcolumn",
		"field_id": 1,
		"field_parent_id": null,
	...
	{
		"fk_field_id": "App TonicsCloud [App Config] [PHP]",
		"field_name": "modular_rowcolumn",
		"field_id": 1,
		"field_parent_id": null,
	...
	{
		"fk_field_id": "App TonicsCloud Nginx Recipe »» [Tonics Simple]",
		"field_name": "modular_rowcolumnrepeater",
		"field_id": 1,
		"field_parent_id": null,
	...
	{
		"fk_field_id": "App TonicsCloud ENV Recipe »» [Tonics]",
		"field_name": "modular_rowcolumn",
		"field_id": 1,
		"field_parent_id": null,
	...
	{
		"fk_field_id": "App TonicsCloud ENV Recipe »» [Laravel]",
		"field_name": "modular_rowcolumn",
		"field_id": 1,
		"field_parent_id": null,
	...
	{
		"fk_field_id": "App TonicsCloud ENV Recipe »» [WordPress]",
		"field_name": "modular_rowcolumn",
		"field_id": 1,
		"field_parent_id": null,
	...
	{
		"fk_field_id": "App TonicsCloud ENV Recipe »» [Manual]",
		"field_name": "modular_rowcolumn",
		"field_id": 1,
		"field_parent_id": null,
	...
	{
		"fk_field_id": "App Tonicscloud App Config Script",
		"field_name": "modular_rowcolumn",
		"field_id": 1,
		"field_parent_id": null,
	...
	{
		"fk_field_id": "App TonicsCloud Script Recipe »» [Manual]",
		"field_name": "input_text",
		"field_id": 1,
		"field_parent_id": null,
	...
	{
		"fk_field_id": "App TonicsCloud Script Recipe »» [Tonics]",
		"field_name": "input_text",
		"field_id": 1,
		"field_parent_id": null,
	...
	{
		"fk_field_id": "App TonicsCloud Script Recipe »» [WordPress]",
		"field_name": "input_text",
		"field_id": 1,
		"field_parent_id": null,
	...
	{
		"fk_field_id": "App TonicsCloud Variable Recipe »» [Common]",
		"field_name": "input_text",
		"field_id": 1,
		"field_parent_id": null,
	...
	{
		"fk_field_id": "App TonicsCloud Nginx Recipe »» [Static Site (HTTPS)]",
		"field_name": "input_text",
		"field_id": 1,
		"field_parent_id": null,
	...
	},
	{
		...
		"field_id": 2,
		"field_parent_id": null,
		"field_options": "{\"field_validations\":[],\"field_sanitization\":[],\"field_slug\":\"input_text\",\"field_slug_unique_hash\":\"1vp0l5u7ld4w000000000\",\"field_input_name\":\"tonicsCloud_standalone_static_site_emailAddress\",\"fieldName\":\"Email Address\",\"inputName\":\"tonicsCloud_standalone_static_site_emailAddress\",\"textType\":\"email\",\"defaultValue\":\"\",\"info\":\"Email Address is required for SSL Cert\",\"hideInUserEditForm\":\"0\",\"placeholder\":\"Enter Email Address (For SSL)\",\"maxChar\":\"\",\"readOnly\":\"0\",\"required\":\"0\",\"styles\":\"\"}"
	},
	{
		"fk_field_id": "App TonicsCloud Automation »» [Standalone Static Site]",
		"field_name": "input_text",
	...
	{
		"fk_field_id": "App TonicsCloud Automation »» [Multiple Static Site]",
		"field_name": "modular_rowcolumnrepeater",
		"field_id": 1,
		"field_parent_id": null,
		"field_options": "{\"field_validations\":[],\"field_sanitization\":[],\"field_slug\":\"modular_rowcolumnrepeater\",\"field_slug_unique_hash\":\"28ehadgb7udc000000000\",\"field_input_name\":\"\",\"fieldName\":\"Static Site\",\"inputName\":\"\",\"row\":\"1\",\"column\":\"1\",\"grid_template_col\":\"\",\"info\":\"\",\"hideInUserEditForm\":\"0\",\"disallowRepeat\":\"0\",\"repeat_button_text\":\"Add New Static Site\",\"cell\":\"on\"}"
	},
	{
		"fk_field_id": "App TonicsCloud Automation »» [Multiple Static Site]",
		"field_name": "input_text",
	...
	},
	{
		...
		"field_id": 3,
		"field_parent_id": 1,
		"field_options": "{\"field_validations\":[],\"field_sanitization\":[],\"field_slug\":\"input_text\",\"input_text_cell\":\"1\",\"field_slug_unique_hash\":\"1vp0l5u7ld4w000000000\",\"field_input_name\":\"tonicsCloud_multi_static_site_emailAddress[]\",\"fieldName\":\"Email Address\",\"inputName\":\"tonicsCloud_multi_static_site_emailAddress[]\",\"textType\":\"email\",\"defaultValue\":\"\",\"info\":\"Email Address is required for SSL Cert\",\"hideInUserEditForm\":\"0\",\"placeholder\":\"Enter Email Address (For SSL)\",\"maxChar\":\"\",\"readOnly\":\"0\",\"required\":\"0\",\"styles\":\"\"}"
	},
	{
		"fk_field_id": "App TonicsCloud Automation »» [Multiple Static Site]",
		"field_name": "input_text",
...
JSON;
    ...
    {
        $images = <<<IMAGES

IMAGES;
